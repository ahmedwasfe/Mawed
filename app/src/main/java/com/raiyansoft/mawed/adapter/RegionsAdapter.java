...
public class RegionsAdapter extends RecyclerView.Adapter<RegionsAdapter.RegionsHolder> {
    ...
    public RegionsAdapter(Activity activity, List<RegionData> listRegions, SelectRegionsListener regionsListener) {
    ...
    public RegionsHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new RegionsHolder(inflater.inflate(R.layout.row_governorates, parent, false));
    }
